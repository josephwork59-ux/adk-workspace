...
Demostrates ADK's output_scheme with Pydantic BaseModel.
"""
...
class ProductInfo(BaseModel):
    ...
    color: str = Field(default="No specified", description="Product color if mentioned" )
...
- Extract: product_name, price, storage, amd color (if mentioned)
...
Rules:
- price must be a number (no dollar sign)
